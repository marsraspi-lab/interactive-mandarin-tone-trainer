...
const PRESETS = [
  // Single syllables
  { word: '妈', pinyin: 'mā',   tones: [1],    file: 'ma1.wav',  audioSrc: '/audio/ma1.wav' },
  { word: '麻', pinyin: 'má',   tones: [2],    file: 'ma2.wav',  audioSrc: '/audio/ma2.wav' },
  { word: '马', pinyin: 'mǎ',   tones: [3],    file: 'ma3.wav',  audioSrc: '/audio/ma3.wav' },
  { word: '骂', pinyin: 'mà',   tones: [4],    file: 'ma4.wav',  audioSrc: '/audio/ma4.wav' },
  // Tone pairs
  ...
  { word: '紧张', pinyin: 'jǐnzhāng',tones: [1,3], file: 'jinzhang.wav',   audioSrc: '/audio/jinzhang.wav' },
  ...
  { word: '银行', pinyin: 'yínháng', tones: [2,1], file: 'yinhang.wav',    audioSrc: '/audio/yinhang.wav' },
  { word: '明年', pinyin: 'míngnián',tones: [2,2], file: 'mingnian.wav',   audioSrc: '/audio/mingnian.wav' },
  { word: '苹果', pinyin: 'píngguǒ', tones: [2,3], file: 'pingguo.wav',    audioSrc: '/audio/pingguo.wav' },
  { word: '决定', pinyin: 'juédìng', tones: [2,4], file: 'jueding.wav',    audioSrc: '/audio/jueding.wav' },
  { word: '孩子', pinyin: 'háizi',   tones: [2,0], file: 'haizi.wav',      audioSrc: '/audio/haizi.wav' },
  { word: '老师', pinyin: 'lǎoshī',  tones: [3,1], file: 'laoshi.wav',     audioSrc: '/audio/laoshi.wav' },
  ...
  { word: '电脑', pinyin: 'diànnǎo', tones: [3,4], file: 'diannao.wav',    audioSrc: '/audio/diannao.wav' },
  { word: '姐姐', pinyin: 'jiějie',  tones: [3,0], file: 'jiejie.wav',     audioSrc: '/audio/jiejie.wav' },
  { word: '机场', pinyin: 'jīchǎng', tones: [4,1], file: 'jichang.wav',    audioSrc: '/audio/jichang.wav' },
  { word: '问题', pinyin: 'wèntí',   tones: [4,2], file: 'wenti.wav',      audioSrc: '/audio/wenti.wav' },
  { word: '汉语', pinyin: 'hànyǔ',   tones: [4,3], file: 'hanyu.wav',      audioSrc: '/audio/hanyu.wav' },
  { word: '再见', pinyin: 'zàijiàn', tones: [4,4], file: 'zaijian.wav',    audioSrc: '/audio/zaijian.wav' },
  { word: '谢谢', pinyin: 'xièxie',  tones: [4,0], file: 'xiexie.wav',     audioSrc: '/audio/xiexie.wav' },
];
